                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <form id="form_data" method="POST" enctype="multipart/form-data">
                                            <?= csrf_field(); ?>
                                            <div class="mb-3">
                                                <label for="nama_usaha" class="form-label">Logo Satuan Kerja</label>
                                                <input type="file" class="form-control" id="logo_satker"
                                                    name="logo_satker">
                                            </div>
                                            <div class="mb-3">
                                                <label for="nama_usaha" class="form-label">Nama Satuan Kerja</label>
                                            ...
                                            <div class="mb-3">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <label for="nama_usaha" class="form-label">Call Center</label>
                                                        <input type="text" class="form-control"
