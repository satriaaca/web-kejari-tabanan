    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Data Siaran Pers</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="form_data" enctype="multipart/form-data" data-id="new">
                <?= csrf_field(); ?>
                <input type="hidden" name="jenis" id="jenis" value="siaran_pers"></input>
...
let dtc = {
    "ajax": {
        "url": "<?= $_baseurl . '/api/berita/all/siaran_pers' ?>",
    },
    "autoWidth": false,
    "filter": true,
    "info": true,
