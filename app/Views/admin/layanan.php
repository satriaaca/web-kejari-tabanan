...
$(document).on('submit', '#form_data', function(e) {
    ...
    $.ajax({
        type: "POST",
        url: "<?=site_url('api/layanan/save/');?>" + id,
...
$(document).on('click', '#ubahData', function(e) {
    ...
    $.getJSON('<?=site_url('api/layanan/get/')?>' + id, function(response) {
...
$(document).on('click', '#hapusUsaha', function(e) {
    ...
    var url = '<?=site_url('api/layanan/delete/')?>' + id; // Set the correct URL for your delete endpoint
